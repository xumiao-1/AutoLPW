...
public class NSGAII extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		// add by Miao
		// first get specified solution set
		int idx = 0;
		Solution newSolution;
		SolutionSet initSet = problem_.getInitSet();
		for (; idx < initSet.size() && idx < populationSize; idx++) {
			newSolution = initSet.get(idx);
			newSolution.getDecisionVariables()[0].setLowerBound(4);
			newSolution.getDecisionVariables()[0].setUpperBound(4);
			problem_.evaluate(newSolution);
			problem_.evaluateConstraints(newSolution);
			evaluations++;
			population.add(newSolution);
		} // for
		for (; idx < populationSize; idx++) {
		...
		// print the generation, add by Miao
		FileUtils.outFile.println("#***************");
		FileUtils.outFile.println("#Generation: " + evaluations
				/ populationSize);
		FileUtils.outFile.println("#Population: " + populationSize);
		FileUtils.outFile.println("#***************");
		population.printSolutions(FileUtils.outFile);
		...
		while (evaluations < maxEvaluations) {
			...
			FileUtils.outFile.println("#Generation: " + evaluations
					/ populationSize);
			FileUtils.outFile.println("#Population: " + populationSize);
			FileUtils.outFile.println("#Solution: " + front.get(0));
			FileUtils.outFile.println("#***************");
			offspringPopulation.printSolutions(FileUtils.outFile);
			FileUtils.outFile.flush();
