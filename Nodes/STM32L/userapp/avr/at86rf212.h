...
#define RG_BATMON   (0x11)//same with RF230
...
#define RG_CCA_THRES   (0x09)//same with RF230

/** Offset for register CSMA_BE */
#define RG_CSMA_BE   (0x2f)

/** Offset for register CSMA_SEED_0 */
#define RG_CSMA_SEED_0   (0x2d)//same with RF230

/** Offset for register CSMA_SEED_1 */
#define RG_CSMA_SEED_1   (0x2e)//same with RF230

/** Offset for register FTN_CTRL */
#define RG_FTN_CTRL   (0x18) //same with RF230

/** Offset for register IEEE_ADDR_0 */
#define RG_IEEE_ADDR_0   (0x24)//same with RF230

/** Offset for register IEEE_ADDR_1 */
#define RG_IEEE_ADDR_1   (0x25)//same with RF230

/** Offset for register IEEE_ADDR_2 */
#define RG_IEEE_ADDR_2   (0x26)//same with RF230

/** Offset for register IEEE_ADDR_3 */
#define RG_IEEE_ADDR_3   (0x27)//same with RF230

/** Offset for register IEEE_ADDR_4 */
#define RG_IEEE_ADDR_4   (0x28)//same with RF230

/** Offset for register IEEE_ADDR_5 */
#define RG_IEEE_ADDR_5   (0x29)//same with RF230

/** Offset for register IEEE_ADDR_6 */
#define RG_IEEE_ADDR_6   (0x2a)//same with RF230

/** Offset for register IEEE_ADDR_7 */
#define RG_IEEE_ADDR_7   (0x2b)//same with RF230

/** Offset for register IRQ_MASK */
#define RG_IRQ_MASK   (0x0e)//same with RF230

/** Offset for register IRQ_STATUS */
#define RG_IRQ_STATUS   (0x0f)//same with RF230

/** Offset for register MAN_ID_0 */
#define RG_MAN_ID_0   (0x1e)//same with RF230

/** Offset for register MAN_ID_1 */
#define RG_MAN_ID_1   (0x1f)//same with RF230

/** Offset for register PAN_ID_0 */
#define RG_PAN_ID_0   (0x22)//same with RF230

/** Offset for register PAN_ID_1 */
#define RG_PAN_ID_1   (0x23)//same with RF230

/** Offset for register PART_NUM */
#define RG_PART_NUM   (0x1c)//same with RF230

/** Offset for register PHY_CC_CCA */
#define RG_PHY_CC_CCA   (0x08)//same with RF230

/** Offset for register PHY_ED_LEVEL */
#define RG_PHY_ED_LEVEL   (0x07)//same with RF230

/** Offset for register PHY_RSSI */
#define RG_PHY_RSSI   (0x06)//same with RF230

/** Offset for register PHY_TX_PWR */
#define RG_PHY_TX_PWR   (0x05)//same with RF230

/** Offset for register PLL_CF */
#define RG_PLL_CF   (0x1a)//same with RF230

/** Offset for register PLL_DCU */
#define RG_PLL_DCU   (0x1b)//same with RF230
...
#define RG_SHORT_ADDR_0   (0x20)//same with RF230

/** Offset for register SHORT_ADDR_1 */
#define RG_SHORT_ADDR_1   (0x21)//same with RF230

/** Offset for register TRX_CTRL_0 */
#define RG_TRX_CTRL_0   (0x03)//same with RF230
...
#define RG_TRX_STATE   (0x02)//same with RF230

/** Offset for register TRX_STATUS */
#define RG_TRX_STATUS   (0x01)

/** Offset for register VERSION_NUM */
#define RG_VERSION_NUM   (0x1d)//same with RF230

/** Offset for register VREG_CTRL */
#define RG_VREG_CTRL   (0x10)//same with RF230

/** Offset for register XAH_CTRL_0 */
#define RG_XAH_CTRL_0   (0x2c)//same with RF230,but the name

/** Offset for register XAH_CTRL_1 */
#define RG_XAH_CTRL_1   (0x17)

/** Offset for register XOSC_CTRL */
#define RG_XOSC_CTRL   (0x12)//same with RF230
...
#define SR_MAN_ID_0   0x1e, 0xff, 0//same with RF230

/** Access parameters for sub-register MAN_ID_1 in register RG_MAN_ID_1 */
#define SR_MAN_ID_1   0x1f, 0xff, 0//same with RF230
...
#define SR_MAX_CSMA_RETRIES   0x2c, 0x0e, 1//same with RF230

/** Access parameters for sub-register MAX_FRAME_RETRIES in register RG_XAH_CTRL_0 */
#define SR_MAX_FRAME_RETRIES   0x2c, 0xf0, 4//same with RF230
...
#define SR_PLL_CF   0x1a, 0x1f, 0//same with RF230

/** Access parameters for sub-register PLL_CF_START in register RG_PLL_CF */
#define SR_PLL_CF_START   0x1a, 0x80, 7//same with RF230

/** Access parameters for sub-register PLL_DCU_START in register RG_PLL_DCU */
#define SR_PLL_DCU_START   0x1b, 0x80, 7//same with RF230
...
#define SR_RSSI   0x06, 0x1f, 0//same with RF230
...
#define SR_SHORT_ADDR_0   0x20, 0xff, 0//same with RF230

/** Access parameters for sub-register SHORT_ADDR_1 in register RG_SHORT_ADDR_1 */
#define SR_SHORT_ADDR_1   0x21, 0xff, 0//same with RF230
...
#define SR_TRAC_STATUS   0x02, 0xe0, 5//same with RF230

/** Access parameters for sub-register TRX_CMD in register RG_TRX_STATE */
#define SR_TRX_CMD   0x02, 0x1f, 0//same with RF230
...
#define SR_TX_AUTO_CRC_ON   0x04, 0x20, 5//same name with RF230,but the paramenters

/** Access parameters for sub-register TX_PWR in register RG_PHY_TX_PWR */
#define SR_TX_PWR   0x05, 0x1f, 0//same with RF230,but the paramenters

/** Access parameters for sub-register VERSION_NUM in register RG_VERSION_NUM */
#define SR_VERSION_NUM   0x1d, 0xff, 0//same with RF230

/** Access parameters for sub-register XTAL_MODE in register RG_XOSC_CTRL */
#define SR_XTAL_MODE   0x12, 0xf0, 4//same with RF230

/** Access parameters for sub-register XTAL_TRIM in register RG_XOSC_CTRL */
#define SR_XTAL_TRIM   0x12, 0x0f, 0//same with RF230
...
#define PAD_CLKM_2_MA   (0)//same with RF230,but the name

/** Constant PAD_CLKM_4mA for sub-register SR_PAD_IO_CLKM */
#define PAD_CLKM_4_MA   (1)//same with RF230,but the name

/** Constant PAD_CLKM_6mA for sub-register SR_PAD_IO_CLKM */
#define PAD_CLKM_6_MA   (2)//same with RF230,but the name

/** Constant PAD_CLKM_8mA for sub-register SR_PAD_IO_CLKM */
#define PAD_CLKM_8_MA   (3)//same with RF230,but the name
