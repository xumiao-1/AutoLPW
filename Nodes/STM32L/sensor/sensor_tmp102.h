...
static uint8_t tmp102_write_config(tmp102_write_t *cnfg);
static uint8_t tmp102_read_word_reg(tmp102_read_t *cnfg);
static uint8_t tmp102_read_config_reg(uint8_t addr, uint16_t *value);
static uint8_t tmp102_read_temp_reg(uint8_t addr, uint16_t *value);
static uint8_t tmp102_read_temp_value(uint8_t addr, uint16_t *value);
